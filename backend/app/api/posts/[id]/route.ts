...
export async function POST(req: Request, { params }: { params: { id: string } }) {
    ...
    const { userId, koasId, treatmentId, title, desc, patientRequirement, published, status } = body
  ...
  export async function PATCH(req: Request, { params }: { params: { id: string } }) {
    ...
    const body = await req.json()
    const { userId, koasId, title, desc, patientRequirement, status, published, treatmentId } = body
